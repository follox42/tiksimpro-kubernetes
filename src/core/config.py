...
DEFAULT_CONFIG = {
    ...
    "audio_generator": {
        ...
        "params": {"add_effects": False},
    },
    "media_combiner": {"name": "FFmpegMediaCombiner"},
    "video_enhancer": {
        "name": "VideoEnhancer",
        "params": {"add_intro": True, "add_hashtags": True, "add_music": True},
    },
    "publishers": {
        "tiktok": {
        ...
        "instagram": {
            ...
            "params": {"auto_close": True, "mobile_emulation": True},
            "enabled": False,
        },
    },
    "pipeline": {
