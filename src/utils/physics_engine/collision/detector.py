...
class SpatialGrid:
    ...
    def __init__(
        self, world_width: float, world_height: float, cell_size: float = 100.0
    ):
...
class CollisionDetector:
    ...
    def _check_collision(
        ...
        elif (type_a, type_b) == ("Circle", "Segment") or (type_a, type_b) == (
            "Segment",
            "Circle",
        ):
        ...
        elif (type_a, type_b) == ("Circle", "Ring") or (type_a, type_b) == (
            "Ring",
            "Circle",
        ):
            circle = body_a if type_a == "Circle" else body_b
    ...
    def _circle_circle_collision(
        self, circle_a: Circle, circle_b: Circle
    ) -> Optional[CollisionInfo]:
    ...
    def _circle_segment_collision(
        self, circle: Circle, segment: Segment
    ) -> Optional[CollisionInfo]:
    ...
    def _circle_ring_collision(
        self, circle: Circle, ring: Ring
    ) -> Optional[CollisionInfo]:
...
class ContinuousCollisionDetector:
    ...
    def detect_continuous_collision(
        self, body_a: PhysicsBody, body_b: PhysicsBody, dt: float
    ) -> Optional[CollisionInfo]:
    ...
    def _circle_circle_ccd(
        self, circle_a: Circle, circle_b: Circle, dt: float
    ) -> Optional[CollisionInfo]:
        ...
        t_collision = self._binary_search_collision_time(
            circle_a, circle_b, dt, radius_sum
        )
    ...
    def _binary_search_collision_time(
        self, circle_a: Circle, circle_b: Circle, dt: float, radius_sum: float
    ) -> Optional[float]:
...
class QuadTree:
    ...
    def get_index(self, body: PhysicsBody) -> int:
        ...
        top_quadrant = (
            min_pos.y < horizontal_midpoint and max_pos.y < horizontal_midpoint
        )
