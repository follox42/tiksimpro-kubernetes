...
def demo_harmonics_system():
    ...
    harmonized = generator.add_harmonics(
        fundamental, frequency, samples, harmonics_config
    )
    ...
    with_subharmonics = generator.add_subharmonics(
        harmonized, frequency, samples, subharmonics_config
    )

    save_audio_to_wav(
        with_subharmonics, "temp/demo_harmonics_complex.wav", generator.sample_rate
    )
...
def demo_advanced_envelopes():
    ...
    envelope_custom = generator.create_custom_envelope(
        samples,
        [
    ...
    save_audio_to_wav(
        signal_custom, "temp/demo_envelope_custom.wav", generator.sample_rate
    )
...
def demo_modulations_and_turbulence():
    ...
    save_audio_to_wav(
        turbulent_signal, "temp/demo_turbulence.wav", generator.sample_rate
    )
...
def demo_filters():
    ...
    signal = (
        generator.generate_waveform("square", 220, samples) * 0.3
...
def demo_effects():
    ...
    save_audio_to_wav(
        distortion, "temp/demo_effect_distortion.wav", generator.sample_rate
    )
    save_audio_to_wav(
        bitcrusher, "temp/demo_effect_bitcrusher.wav", generator.sample_rate
    )
...
def demo_complete_instruments():
    ...
    piano_config = {
        ...
        "filters": [{"type": "lowpass", "cutoff": 2000, "resonance": 0.3}],
        "effects": [{"type": "reverb", "room_size": 0.3, "wet_level": 0.2}],
    }

    piano_sound = generator.generate_advanced_sound(piano_config)
    save_audio_to_wav(
        piano_sound, "temp/demo_instrument_piano.wav", generator.sample_rate
    )
    ...
    lead_config = {
        ...
        "filters": [{"type": "lowpass", "cutoff": 1500, "resonance": 0.8}],
        "effects": [
    ...
    save_audio_to_wav(
        lead_sound, "temp/demo_instrument_lead.wav", generator.sample_rate
    )
    ...
    perc_config = {
        ...
        "volume": 0.9,
        "waveform": "noise",
        "subharmonics": [{"divisor": 2, "amplitude": 0.4, "waveform": "sine"}],
        "envelope": {
            "type": "custom",
            "points": [(0, 0), (0.01, 1), (0.05, 0.3), (0.3, 0.1), (1, 0)],
        },
        "turbulence": {"noise_type": "brown", "noise_amount": 0.3},
        "filters": [{"type": "bandpass", "low_freq": 80, "high_freq": 300}],
        "effects": [
    ...
    save_audio_to_wav(
        perc_sound, "temp/demo_instrument_percussion.wav", generator.sample_rate
    )
...
def demo_extreme_sound_design():
    ...
    texture_config = {
        ...
        "filters": [{"type": "lowpass", "cutoff": 500, "resonance": 0.9}],
        "effects": [
    ...
    save_audio_to_wav(
        texture_sound, "temp/demo_extreme_texture.wav", generator.sample_rate
    )
...
def create_preset_library():
    ...
    presets = {
        ...
        "space_pad": {
            ...
            "config": {
                ...
                "filters": [{"type": "lowpass", "cutoff": 1000, "resonance": 0.3}],
                "effects": [
    ...
    print(
        "✅ Bibliothèque de presets sauvegardée dans sound_presets/advanced_presets.json"
    )
    ...
    for preset_name, preset_data in presets.items():
        ...
        save_audio_to_wav(
            sound, f"temp/preset_{preset_name}.wav", generator.sample_rate
        )
...
def main():
    ...
    try:
        ...
        print(
            "   • Formes d'ondes: sine, square, sawtooth, triangle, pulse, noise, pink, brown"
        )
