...
class TikTokConnector:
    ...
    def __init__(
        self, cookies_file: str = "tiktok_cookies.pkl", headless: bool = False
    ):
        ...
        if os.path.exists(self.cookies_file):
            try:
                ...
                if self._is_logged_in():
                    ...
                    logger.info(
                        "Les cookies sauvegardés ne sont plus valides pour TikTok"
                    )
                    return False
    ...
    def _is_logged_in(self) -> bool:
        ...
        try:
            ...
            if (
                "tiktok.com/tiktokstudio" in current_url and "login" not in current_url
            ) or "creator-center/upload" in current_url:
                return True
            ...
            profile_elements = self.driver.find_elements(
                By.XPATH, "//a[contains(@href, '/profile') or contains(@href, '/@')]"
            )

            if profile_elements and any(
                elem.is_displayed() for elem in profile_elements
            ):
                return True
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            print("\n" + "=" * 80)
            print(
                "VEUILLEZ VOUS CONNECTER MANUELLEMENT À TIKTOK DANS LA FENÊTRE DU NAVIGATEUR"
            )
            ...
            while time.time() - start_time < max_wait_time:
                ...
                print(
                    f"Vérification de connexion TikTok... URL: {self.driver.current_url}"
                )
